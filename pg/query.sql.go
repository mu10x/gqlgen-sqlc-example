...
SELECT id, title, description, cover FROM books WHERE id = $1
`
...
SELECT id, name, website, agent_id FROM authors ORDER BY name
`
...
SELECT id, title, description, cover FROM books ORDER BY title
`
